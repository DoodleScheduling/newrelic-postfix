...
public class ConfigTest {
    ...
    public void testLoadWithValidJson() throws IOException, URISyntaxException {
        ...
        assertEquals(10.3f, Float.valueOf(Config.getValue("float_test").toString()), 0.01f);
        ...
        assertEquals(25L, Double.valueOf(Config.getValue("log_max_size_in_mb").toString()), 0.1);
        ...
        Map<String, Object> three = listProp.get(0);
        assertEquals(3L, three.get("three"));
        Map<String, Object> four = listProp.get(1);
    ...
    private File getFile(String fileName) throws URISyntaxException {
        return new File(ConfigTest.class.getClassLoader().getResource(fileName).toURI());
    }
}
